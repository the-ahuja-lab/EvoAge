...
echo "[$(date)] Activated env and set DGLBACKEND. Launching RotatE training…"
...
exec stdbuf -o0 -e0 dglke_train \
  ...
  --save_path        /storage/Arushi/090526_EvoAge/kg_formation/training_2/EvoAge_121_12M/model_output/Rotate \
  --gpu              0 \
  -adv \
  -a 1.0 \
  --valid 