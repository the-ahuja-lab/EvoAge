...
echo "[$(date)] Activated env and set DGLBACKEND. Launching SimplE training…"
...
exec stdbuf -o0 -e0 dglke_train \
  ...
  --save_path        /storage/Arushi/090526_EvoAge/kg_formation/training_2/EvoAge_121_12M/model_output/Dismult \
  --gpu              1 \
  -adv \
  -a 1.0 \
  --valid \
