...
exec stdbuf -o0 -e0 dglke_eval \
  ...
  --data_files       entities_final.dict relation_final.dict EvoAge_1to1_KG_train_90.txt EvoAge_1to1_KG_valid_10.txt EvoAge_1to1_KG_test.txt \
  --format udd_hrt \
  --model_path /storage/Arushi/090526_EvoAge/kg_formation/training_2/EvoAge_1_to_1/model_output/Rescal/RESCAL_Evoage_1_to_1_0 \
  --hidden_dim 64 \
  --gamma 12.0 \
  --batch_size_eval 512 \
