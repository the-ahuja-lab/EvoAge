# Step 06 — Final KG Building & Train/Valid/Test Splitting
...
│       ├── entities_final.dict
│       ├── relation_final.dict
│       └── unmapped_triples_Aging_specific_1_to_1.csv
│
...
│       ├── EvoAge_121_12M_KG_valid_10.pt|.txt
│       ├── entities_final.dict
│       ├── entities_final_Ntype_updated.dict
│       └── relation_final.dict
│
└── 1_percent_species_test_set.ipynb                   ← Exploratory notebook
```
