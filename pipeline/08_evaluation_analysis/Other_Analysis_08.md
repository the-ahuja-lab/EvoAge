# Step 08 — Granular 1% Species & Cross-Species Evaluation Analysis
...
## 3. Test Set Splitting Logic

The evaluation dataset is divided into two primary categories:

### 3.1. Species-Specific 1% Test Sets (Within-Species Biology)
...
### 3.2. Cross-Species 1% Test Set (Cross-Species Interactions)
...
### 4.1. Model Training
Trained via DGL-KE utilizing the [Run2_per_Rescal_64.sh](file:///storage/Arushi/090526_EvoAge/kg_formation/DOCUMENTATION/Other_Analysis_08/building_evoage_with_1_percent_species_testsplit/Training/Run2_per_Rescal_64.sh) script:
...
Executed via the [Run3_Rescal_64_testing.sh](file:///storage/Arushi/090526_EvoAge/kg_formation/DOCUMENTATION/Other_Analysis_08/building_evoage_with_1_percent_species_testsplit/Training/Run3_Rescal_64_testing.sh) script using CPU-parallel threads (`dglke_eval`).

### 4.3. Relation / Edge Type Prediction Evaluation
Executed via the [Run4_per_rescal_edge_type_metrics.py](file:///storage/Arushi/090526_EvoAge/kg_formation/DOCUMENTATION/Other_Analysis_08/building_evoage_with_1_percent_species_testsplit/Training/Run4_per_rescal_edge_type_metrics.py) script. It evaluates the rank of the true relation out of all 89 candidate relations in a chunked manner on the GPU.

---

## 5. Evaluation Results

### 5.1. Task A — Relation / Edge Type Prediction `(h, ?, t)`
...
### 5.2. Task B — Link Prediction `(?, r, t)` / `(h, r, ?)`
